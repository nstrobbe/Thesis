...
The gluino, which is a color octet, cannot mix with any other particle. In this respect it is unique
...
Finally, gluinos can only decay through a squark, wich can be on-shell or not. 
