...
\begin{figure}[p]
\centering
\includegraphics[width=0.9\textwidth]{figures/razor_trigger/h_HT_j1pt_pre_eff_ph_l_BPS}

\includegraphics[width=0.9\textwidth]{figures/razor_trigger/MR_R2_bg_trig_eff_BPS}
