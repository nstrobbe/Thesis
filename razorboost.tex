...
The razor boost analysis is a search for new massive particles in hadronic final states with at
least one highly boosted $\W$ boson and $\cPqb$ jet.  Boosted $\W$ boson candidates are identified
using jet substructure techniques. The razor variables $\mr$ and $\rsq$ are used to characterize
the signal as a peak on a falling background.
...
%which is explained in more detail in Appendix~\ref{app:CLs}. 
