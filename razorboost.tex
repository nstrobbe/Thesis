...
In this section I will discuss the event selection, starting by a review of 
...
\includegraphics[width=0.49\textwidth]{figures/razor_variables/MR_R2_jet1ptg200_sig_v2}
...
As no discrepancy from the SM prediction is observed, we compute upper limits on the allowed
