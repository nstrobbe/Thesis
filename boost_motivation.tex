...
\begin{figure}[htpb]
  ...
  % TODO add more to the caption, describing what is on the figure
...
The simplified models (see Section~\ref{sec:sms} for more information) corresponding to the
...
% TODO: Add these plots (or make better ones)
% \begin{figure}[htpp]
% \centering
% \includegraphics[width=0.49\textwidth]{figures/T1ttcc/Signal_comparison_T1ttcc_gen_Wpt}
% \includegraphics[width=0.49\textwidth]{figures/T1t1t/Signal_comparison_T1t1t_gen_Wpt}
% \caption{Generator $\PW$ \pt for several signal points of the T1ttcc (left) and T1t1t (right)
% simplified models.
% \label{fig:gen_Wpt}}
% \end{figure}
% 
...
% \caption{Generator top \pt for several signalpoints of the T1ttcc (left) andT1t1t (right) simplified
% models.
% \label{fig:gen_toppt}}
% \end{figure}
