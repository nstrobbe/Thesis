...
events. The $\Delta\phi_{min}$ distribution before applying this selection is shown in
...
\begin{figure}[htbp]
 ...
 {figures/razor_selection/plots/DataMC_minDeltaPhi_g1Mbg1W0Ll_rebin}
\caption{Comparison between data and simulation for the $\Delta\phi_{min}$ distribution with
all signal region requirements applied except $\Delta\phi_{min} > 0.5$.
