...
\chaptermark{Generation, simulation, reconstruction}
...
incorporating everything that is known about the workings of the Standard Model, and the new physics
...
physics process. This could be, for example, the particles that result from the production and
...
We reject events in which the particle flow missing transverse energy vector, $\VEtmiss(\text{PF})$,
