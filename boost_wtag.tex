...
We shall require that the pruned jet mass be consistent with the $\W$ boson mass,
\begin{equation}
...
As explained in Section~\ref{sec:boost_strategy}, we use three control regions to select data
